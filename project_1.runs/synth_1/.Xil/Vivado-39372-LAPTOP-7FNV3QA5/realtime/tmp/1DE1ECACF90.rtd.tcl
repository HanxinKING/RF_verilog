...
set genomeRtd $env(RT_TMP)/1DE1ECACF90.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {cnn1d_complex_feature_extractor9_deploy_top_fpga_mix12__GB0}]"
...
set genomeName [subst -nocommands -novariables {cnn1d_complex_feature_extractor9_deploy_top_fpga_mix12__GB0}]
